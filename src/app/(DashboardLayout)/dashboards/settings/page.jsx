...
const Profile = () => {
  ...
  const StatCard = ({ title, value, icon: Icon, color }) => (
    <div className="bg-gray-800/50 rounded-2xl p-4 sm:p-6 hover:bg-gray-800/70 transition-all">
      ...
      <div className="relative w-full aspect-square max-w-[12rem] mx-auto mb-4">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-4xl sm:text-6xl lg:text-8xl font-custom text-primary/50">{value}</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-4 sm:p-6">
      <div className="max-w-6xl mx-auto">
        <div className="bg-gray-800/30 rounded-2xl p-4 sm:p-8 mb-6 sm:mb-8">
